...
complete.cases(iris)
```
* So we can see that we have some continuous variables (Petal.width, Sepal.width...) and categorical variables (Species).
* Therefore, let us try to plot a scatter and bar chart with the data. 
```{r}
