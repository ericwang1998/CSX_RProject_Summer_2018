...
ggplot(price_mod, aes(Fitted, Residuals, colour = Treatment)) +
  geom_point()
```
#### 我们可以看到group3 和group4 的residual 跟fitted 的差异都不大。於是我們可以說越高檔次的餐廳，越有可能得到好評，但效應會逐漸遞減。